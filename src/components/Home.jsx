...
const CheckIcon = () => (
  <svg className="inline w-6 h-6 text-blue-400 mr-2" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24">
...
const Home = () => {
  return (
    ...
    >
      <div className="bg-black/80 rounded-[3rem] border border-blue-400/30 shadow-2xl max-w-4xl w-full mx-4 py-12 px-8 flex flex-col items-center backdrop-blur-xl mt-8 md:-mt-16">
        ...
        <p className="text-white text-lg md:text-xl font-semibold mb-8 leading-relaxed drop-shadow-md">
          En Fiscalizate de Sandoval & Co., nos especializamos en brindar asesoría contable, fiscal y financiera a emprendedores y empresas de todos los tamaños.
          Nuestro objetivo es ayudarte a cumplir con todas las normativas legales, optimizar tus recursos y asegurar el crecimiento sostenible de tu negocio.
        </p>
